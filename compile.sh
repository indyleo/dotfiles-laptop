...
mv autostart-scripts sxhkd polybar Thunar neofetch nvim ranger picom awesome kitty rofi starship.toml mimeapps.list user-dirs.dirs greenclip.toml ~/.config/
