...
echo "#############################"
nala install polybar galculator kitty bleachbit timeshift dconf-editor virt-manager xinit sxhkd arandr xterm xclip rofi-dev xbacklight xsel \
  xdotool screenkey gedit gedit-plugins xorg xserver-xorg xserver-xephyr -y

echo "############################"
echo "## Installing Media Stuff ##"
echo "############################"
nala install rhythmbox rhythmbox-plugins rhythmbox-data playerctl pavucontrol pamixer yt-dlp mpv peek vlc sxiv pulsemixer mediainfo ffmpegthumbnailer ffmpeg -y
...
echo "##################################"
nala install xwallpaper flameshot lxpolkit rofi i3lock-fancy picom -y
